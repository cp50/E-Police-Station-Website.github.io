...
<DOCTYPE html>
    ...
    <body style="background: url(https://media.istockphoto.com/id/1007122208/vector/grey-and-white-geometric-triangles-backgorund.jpg?s=612x612&w=0&k=20&c=Qk4uuwQUj4ElhWZ-E1qfnHIezG2ljxc2uAjtgEZxYWs=)"><h1 align=center>ADMIN</h1>
     <div class="row">
          <div class="column">
              <div class="card">
                  <h3>Add Officials</h3>
                  <a href="addofficials.php">click here</a>
          ...
          <div class="column">
              <div class="card">
              <h3>View and Update Officials</h3>
                  <a href="viewandupdateofficials.php">Click here</a>
