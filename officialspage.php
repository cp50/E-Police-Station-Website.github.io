...
<DOCTYPE html>
    ...
    <body style="background: url(https://media.istockphoto.com/id/1007122208/vector/grey-and-white-geometric-triangles-backgorund.jpg?s=612x612&w=0&k=20&c=Qk4uuwQUj4ElhWZ-E1qfnHIezG2ljxc2uAjtgEZxYWs=)">
        <button type="button" style="float:right" class="btn btn-outline-primary btn-lg"><a href="home.php">BACK</a></button><h1 align=center>OFFICIALS</h1>

      <div class="row">
          <div class="column">
              <div class="card">
                  <h3>View and Update complaints</h3>
                  <a href="offviewandupdatecomplaint.php">click here</a>
          ...
          <div class="column">
              ...
              <h3>FIR management</h3>
                  <a href="firmanagement.php">click here</a>
           ...
           <div class="column">
              <div class="card">
              <h3>Live View</h3>
                  <a href="officialliveview.php">click here</a>
                  <img class="card-img-top" src="https://www.pngguru.in/storage/uploads/images/Red%20Live%20Text%20free%20transparent%20png_1657819996_531168101.webp">
